    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-pencil-square"></i> Alterar Nome de Usuário</h5>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-envelope-fill"></i> Alterar E-mail</h5>
                    <form action="profileUpdate" method="post">
                        <div class="input-group">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-key-fill"></i> Alterar Senha</h5>
                    <form action="profileUpdate" method="post">
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-warning" name="action" value="updatePassword">
            ...
            <div class="card border-danger shadow-sm">
                <div class="card-body">
                    <h5 class="card-title text-danger"><i class="bi bi-trash3-fill"></i> Excluir Conta</h5>
                    ...
                    <form action="profileUpdate" method="post" onsubmit="return confirmDelete();">
                        <div class="mb-3">
                            <label for="deletePassword" class="form-label">Confirme sua senha:</label>
                        ...
                        <button type="submit" class="btn btn-danger w-100" name="action" value="deleteAccount" name="deleteAccount">
